...
alex_table = Data.Array.listArray (0 :: Int, 321)
  [ 0
  , 12
  , 12
  , 12
...
alex_check = Data.Array.listArray (0 :: Int, 321)
  [ -1
  , 9
  , 10
  , 11
...
alex_actions = Data.Array.array (0 :: Int, 17)
  [ (16,alex_action_8)
  , (15,alex_action_7)
  , (14,alex_action_6)
  , (13,alex_action_5)
...
alex_action_8 = \s -> AND
alex_action_9 = \s -> OR
alex_action_10 = \s -> GTH
alex_action_11 = \s -> GEQTH
alex_action_12 = \s -> LTH
alex_action_13 = \s -> LEQTH
alex_action_14 = \s -> NOT
alex_action_15 = \s -> EQU
alex_action_16 = \s -> DIFF
